...
1> Characters 0-191:
1> Error: Some type variables are unbound in this type:
1>          class ['a] stack :
1>            'b list ->
1>            object
1>              val mutable v : 'b list
1>              method pop : 'b option
1>              method push : 'b -> unit
1>            end
1>        The method pop has type 'b option where 'b is unbound
```
...
(new square 5 :> shape) ;;
1> Characters 0-23:
1> Error: Type square = < area : float; equals : square -> bool; width : int >
1>        is not a subtype of shape = < area : float; equals : shape -> bool > 
1>        Type shape = < area : float; equals : shape -> bool >
1>        is not a subtype of
1>          square = < area : float; equals : square -> bool; width : int >
```
...
let o = new obj 3 ;;
1> Creating obj 3
1> Initializing field:: val o : obj = <obj>
```
...
```sh
  ...
  File "jbuild", line 7, characters 15-29:
